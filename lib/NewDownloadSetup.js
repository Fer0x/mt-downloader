...
Setup_New_Download.prototype.execute = function(callback) {
	...
	this.tasks = {
		...
		'http-head': ['file-handle', function(callback, results) {
			u.executor(HeadRequest, options.url, options, results['file-handle'])(callback);
		}],
		...
		'validate-download': ['http-data', function(callback, results) {
			u.executor(DownloadValidator, results['meta-read'].threads, results['file-handle'])(callback);
		}],
